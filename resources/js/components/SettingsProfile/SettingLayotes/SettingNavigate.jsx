...
const SettingNavigate = () => {
    ...
    const settings = [
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M5 2h6a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1m2.5 5.5v1h-5v-1zm0 2v1h-5v-1zm0 2v1h-5v-1z"/>
                </svg>
            ),
            title: "Оформление",

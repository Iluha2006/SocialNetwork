...
import { useCreatePostMutation } from '../../api/modules/postApi';
...
const CreatePost = () => {
    ...
    return (
        <div className="w-full max-w-96 sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto my-5 p-5 bg-[#0a1929] rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5">
                    ...
                    <input
                        ...
                        required
                        className="w-full px-3 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white focus:border-blue-500 focus:outline-none transition-colors"
                    />
                </div>
                ...
                <div className="mb-5">
                    ...
                    <textarea
                        ...
                        rows="5"
                        className="w-full px-3 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white focus:border-blue-500 focus:outline-none transition-colors resize-y min-h-[150px]"
                    />
                </div>
                ...
                <div className="mb-5">
                    ...
                    {video && (
                        <div className="mt-3 p-3 bg-gray-800 rounded-lg">
                            <video controls className="max-w-full max-h-80 rounded-lg mx-auto">
